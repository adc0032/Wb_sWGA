...
plink1.9/plink --vcf snp_calls/Wb.10k.54.miss.recode.vcf.chrnames
--indep-pairwise 100 30 .38 --set-missing-var-ids @:#\ \$1,\$2
--allow-extra-chr
@author: scott
"""
...
parser.add_argument('pruneIN', metavar="pruneIN", type=str,
                    help="prune.in file from plink")
